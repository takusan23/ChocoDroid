...
import io.github.takusan23.htmlparse.data.channel.*
import io.github.takusan23.htmlparse.data.search.MoreSearchResponseData
...
class ChannelAPI {
    ...
    suspend fun getChannelUploadVideo(channelId: String): ChannelResponseData {
        ...
        // 追加読み込み用
        NEXT_PAGE_CONTINUATION = tokenGetRegex.find(responseBody)!!.groupValues[1]
        // 多分投稿動画はtab[1]
